...
class Dnet(nn.Module):
    def __init__(self, n, arch = get_cadene_model('densenet121'), pre=True, ps=0.5):
        ...
        self.layer1 = nn.Sequential(
            ...
            m.features.denseTurtle1)
        self.layer2 = nn.Sequential(m.features.transition1,m.features.denseTurtle2)
        self.layer3 = nn.Sequential(m.features.transition2,m.features.denseTurtle3)
        self.layer4 = nn.Sequential(m.features.transition3,m.features.denseTurtle4,
                                    m.features.norm5)
